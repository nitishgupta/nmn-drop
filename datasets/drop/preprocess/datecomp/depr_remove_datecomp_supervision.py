        ...
        if passage_idx in choosen_passage_idxs:
            ...
            for question_answer in passage_info[constants.qa_pairs]:
                ...
                (qevent1_date_grounding,
                 qevent2_date_grounding) = question_answer[constants.qspan_dategrounding_supervision]
                ...
                question_answer[constants.qspan_dategrounding_supervision] = (qevent1_date_grounding,
                                                                              qevent2_date_grounding)
                question_answer[constants.qspan_datevalue_supervision] = (qevent1_date_value,
                                                                          qevent2_date_value)
