...
PRUNE_DATE_DIR=${ROOT_DIR}/date_prune
PRUNE_DATE_AUGMENT_DIR=${ROOT_DIR}/date_prune_augment
...
python -m datasets.drop.preprocess.prune_date_comparison --input_trnfp ${DATE_DIR}/${TRAIN_FILENAME} \
                                                         --input_devfp ${DATE_DIR}/${DEV_FILENAME} \
                                                         --output_trnfp ${PRUNE_DATE_DIR}/${TRAIN_FILENAME} \
                                                         --output_devfp ${PRUNE_DATE_DIR}/${DEV_FILENAME}  \


python -m datasets.drop.preprocess.date_data_augmentation --input_trnfp ${PRUNE_DATE_DIR}/${TRAIN_FILENAME} \
