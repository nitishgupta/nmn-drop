...
SERIALIZATION_DIR=./resources/semqa/checkpoints/drop/merged_data/date_yd_num_hmyw_cnt_whoarg_1200_full/drop_parser_bert/EXCLOSS_false/MMLLOSS_true/aux_true/SUPEPOCHS_3/S_10/BeamSize2
WEIGHTS_TH=best.th
