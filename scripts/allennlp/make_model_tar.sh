...
SERIALIZATION_DIR=./resources/checkpoints/drop-iclr21/diff_compsplit-v3/drop_parser_bert/Qattn_true/EXCLOSS_true/aux_false/IO_true/SHRDSUB_true/SUPEPOCHS_0_BM_1/S_10-FGS-DCYD-ND-MM
WEIGHTS_TH=best.th
