...
SERIALIZATION_DIR=./resources/checkpoints/drop-iclr21/iclr_qdmr-v2-noexc-aug/drop_parser_bert/Qattn_true/EXCLOSS_true/aux_false/IO_true/SHRDSUB_true/SUPEPOCHS_0_BM_1/S_10-FGS-DCYD
WEIGHTS_TH=best.th
