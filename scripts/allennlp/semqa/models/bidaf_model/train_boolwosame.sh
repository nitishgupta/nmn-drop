...
CONFIGFILE=allenconfigs/semqa/train/bidaf_model.jsonnet
export VOCABDIR=./resources/semqa/vocabs/hotpotqa/merged_contexts/bool_wosame/gold_contexts/bidaf/vocabulary
