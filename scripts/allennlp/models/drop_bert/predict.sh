...
# SAVED MODEL
MODEL_DIR=./resources/semqa/checkpoints/drop/date_num/date_numcq_hmvy_cnt_relprog_500/drop_parser_bert/CNTFIX_false/aux_true/SUPEPOCHS_5/S_10/BertModelRelAux15
