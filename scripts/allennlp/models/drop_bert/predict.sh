...
# SAVED MODEL
MODEL_DIR=/shared/nitishg/semqa/checkpoints/drop/generalization/min_max/drop_parser_bert/EXCLOSS_true/MMLLOSS_true/aux_true/SUPEPOCHS_0/S_1/BeamSize1_HEM0
...
# FULL_VALFILE=/shared/nitishg/data/interpret-drop/interpret_dev/interpret_dev_manual_wanno_v2.json

# Prediction output including verbose execution logs
PREDICTOR=drop_parser_predictor
PREDICTION_FILE=${PREDICTION_DIR}/generalization_dev_verbosepred.txt

# PREDICTION_FILE=${PREDICTION_DIR}/interpret_dev_predictions.txt
