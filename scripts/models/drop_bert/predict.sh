...
# SAVED MODEL
MODEL_DIR=./resources/checkpoints/drop-iclr21/iclr_qdmr-v1-noexc/drop_parser_bert/Qattn_true/EXCLOSS_true/aux_false/IO_true/SHRDSUB_false/SUPEPOCHS_0_BM_1/S_42_S10
# ./resources/checkpoints/drop-iclr21/nummin_compsplit-noexc/drop_parser_bert/Qattn_true/EXCLOSS_true/aux_false/IO_true/SHRDSUB_true/SUPEPOCHS_0_BM_1/S_10_FGS_S10
...
DATASET_NAME=iclr_qdmr-v1-noexc
# iclr_qdmr-v1
# qdmr-v1
# iclr20_full-v1
