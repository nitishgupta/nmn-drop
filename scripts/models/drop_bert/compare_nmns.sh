...
MODEL2=/shared/nitishg/checkpoints/drop-w-qdmr/iclr-full-qdmr-filter-v2-ss/drop_parser_bert/Qattn_true/EXCLOSS_true/aux_true/IO_true/SHRDSUB_true/SUPEPOCHS_0_HEM_0_BM_1/S_5/predictions/qdmr-filter-v2-ss_dev_predictions.jsonl
