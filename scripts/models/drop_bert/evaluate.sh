...
# SAVED MODEL
MODEL_DIR=./resources/semqa/checkpoints/drop/drop_iclr600_wqdmr/drop_parser_bert/Qattn_true/EXCLOSS_true/MMLLOSS_true/aux_true/SUPEPOCHS_5_HEM_3_BM_1/S_42_QaTT
