...
TRAINFILE=${DATASET_DIR}/${DATASET_NAME}/squad-train-v1.1_drop-wcontrastive_dep.json
...
CONFIGFILE=training_config/squad_parser_bert.jsonnet
...
SERIALIZATION_DIR=${SERIALIZATION_DIR_ROOT}/${MODEL_DIR}/${PD_1}/S_${SEED}_PreBIO_DEP
