...
def _convert_finalstates_to_actions(best_final_states: Dict[int, List[StateType]],
    ...
    (instanceidx2actionseq_idxs,
     ...
     instanceidx2actionseq_sideargs) = _get_actionseq_idxs_and_scores(best_final_states, batch_size)

    return _get_actionseq_strings(possible_actions,
                                  instanceidx2actionseq_idxs,
                                  instanceidx2actionseq_scores,
...
def _get_actionseq_idxs_and_scores(best_final_states: Dict[int, List[StateType]],
                                   batch_size: int):
    instanceidx2actionseq_idxs = {}
    instanceidx2actionseq_scores = {}
    instanceidx2actionseq_sideargs = {}
...
def _get_actionseq_strings(possible_actions: List[List[ProductionRule]],
