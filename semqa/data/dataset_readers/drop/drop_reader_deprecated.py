...
@DatasetReader.register("drop_reader_deprecated")
class DROPReaderDeprecated(DatasetReader):
    def __init__(self,
                 lazy: bool = True,
    ...
    def prune_for_question_len(self, max_question_len, answer_question_spans, ques_attn_supervision):
        ...
        print(ques_attn_supervision)
        print(new_answer_question_spans)
        print(new_qattn_supervision)
        print()
    ...
    def text_to_instance(self,
        ...
        (p_date_mens, p_date_entidxs, p_date_normvals,
         ...
         answer_passage_spans,
         datecomp_ques_event_date_groundings,
         numcomp_qspan_num_groundings) = self.prune_for_passage_len(max_passage_len,
                                                                    p_date_mens, p_date_entidxs, p_date_normvals,
                                                                    p_num_mens, p_num_entidxs, p_num_normvals,
                                                                    answer_passage_spans,
                                                                    datecomp_ques_event_date_groundings,
