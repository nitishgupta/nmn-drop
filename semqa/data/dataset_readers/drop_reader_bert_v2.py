...
from semqa.domain_languages.drop_language_v2 import DropLanguageV2, Date, get_empty_language_object
...
@DatasetReader.register("drop_reader_bert_v2")
    ...
    def text_to_instance(
        ...
        (composed_numbers, passage_number_values,
         ...
         nums_from_addition, nums_from_subtraction) = self.compute_number_support(
            ...
            implicit_numbers=DropLanguageV2.implicit_numbers,
