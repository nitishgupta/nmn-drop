...
from semqa.domain_languages.hotpotqa_lang import HotpotQALanguage, HotpotQALanguageWSideArgs, HotpotQALanguageWOSideArgs
from depr.hotpotqa_model.hotpotqa_parser_base import HotpotQAParserBase
from semqa.domain_languages.hotpotqa_lang.execution_params import ExecutorParameters
...
class HotpotQASemanticParser(HotpotQAParserBase):
    ...
    def forward(self,
        ...
        gold_ans_type: List[str]=None
            List of Ans's types from datasets.hotpotqa_model.constants
        kwargs: ``Dict``
